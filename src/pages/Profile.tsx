      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-6 relative z-10">
        ...
        <div className="border border-white/6 border-t-2 border-t-[#00D4FF]/40 bg-[#0c0f18] p-6">
          <div className="flex items-start gap-6">
            {/* Avatar */}
            <div className="w-16 h-16 bg-[#111520] border border-white/8 flex items-center justify-center relative">
              <span className="text-lg font-mono text-[#00D4FF]">{(profile?.username || "?").slice(0, 2).toUpperCase()}</span>
              <span className="absolute bottom-0 right-0 w-3 h-3 bg-[#00FF87] border-2 border-[#0c0f18] animate-pulse" />
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-4 mt-3">
                <div className="text-center">
                  <div className="text-base font-black font-mono text-cyan-400">{stats?.totalMatches || 0}</div>
                  <div className="text-[9px] text-[#3D4657] uppercase tracking-widest">Battles</div>
                </div>
                <div className="text-center">
                  <div className="text-base font-black font-mono text-cyan-400">{stats?.winRate || 0}%</div>
                  <div className="text-[9px] text-[#3D4657] uppercase tracking-widest">Win Rate</div>
                </div>
                <div className="text-center">
                  <div className="text-base font-black font-mono text-cyan-400">{stats?.totalScore || 0}</div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-px bg-white/6 mb-6">
              {[
                ...
                <div
                  key={stat.label}
                  className="bg-[#0c0f18] border border-cyan-500/15 p-3 flex flex-col gap-1"
                >
