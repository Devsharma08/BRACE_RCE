    ...
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-void">
      ...
      >
        ...
        <div className="flex items-center justify-between w-full">
          <div className="text-center"><div className="text-xl font-black text-cyan-400 font-mono">1v1</div><div className="text-[9px] text-[#3D4657] uppercase tracking-[0.15em]">Live battles</div></div>
          <div className="text-center"><div className="text-xl font-black text-cyan-400 font-mono">12+</div><div className="text-[9px] text-[#3D4657] uppercase tracking-[0.15em]">Languages</div></div>
          <div className="text-center"><div className="text-xl font-black text-cyan-400 font-mono">Real</div><div className="text-[9px] text-[#3D4657] uppercase tracking-[0.15em]">Execution</div></div>
        </div>
      </div>
