...
export const initSocketServer = (io: Server) => {
    ...
    io.on("connection", (socket: Socket) => {
        ...
        socket.on("send_direct_message", async (data: { targetUserId: string, content: string }) => {
            ...
            try {
                const { notifyDirectMessage } = await import("./notificationService.js");
        ...
        socket.on("send_challenge", async (data: {
            ...
            try {
                const { notifyChallenge } = await import("./notificationService.js");
        ...
        socket.on("accept_challenge", async (data: {
            ...
            try {
                const { notifyChallengeResult } = await import("./notificationService.js");
